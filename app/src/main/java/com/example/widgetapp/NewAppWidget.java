...
public class NewAppWidget extends AppWidgetProvider {
    ...
    private static final String sharedPrefFile = "com.example.widgetapp";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, appWidgetId, intentUpdate, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_MUTABLE);
